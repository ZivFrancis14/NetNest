...
router.post("/rooms/:room_id/answers", (req, res) => voteController.submitAnswer(req, res));
router.get("/rooms/:room_id/statistics/:scenario_id", (req, res) => voteController.getStatistics(req, res));
